...
![Terraform apply complete](screenshots/03-terraform-apply.png)

![EC2 instances running](screenshots/04-ec2-instances.png)
...
![EKS cluster and nodes ready](screenshots/05-eks-nodes.png)
...
![Installed plugins](screenshots/07-plugins-installed.png)

![Docker Hub credentials in Jenkins](screenshots/08-jenkins-credentials.png)
...
![Image on Docker Hub](screenshots/09-dockerhub.png)
...
![Grafana dashboard](screenshots/14-grafana.png)
...
![Jenkins pipeline — all stages successful](screenshots/10-pipeline-success.png)
...
![Pods running and service with LoadBalancer](screenshots/11-pods-running.png)

![LoadBalancer service details](screenshots/12-loadbalancer.png)

![Application live on the LoadBalancer URL](screenshots/13-app-live.png)
